(ns shop3-zmq.planner-test
  (:require
   ...
   [mznp.rewrite            :as rw]
   [shop3-zmq.planner  :as plan]
   [shop3-zmq.specs    :as specs]
...
(defn ^:diag ns-setup!
  ...
  (alias 'dom    'shop3-zmq.domain)
  ;(alias 'domt    'shop3-zmq.domain-test)
  (alias 'how    'shop3-zmq.how-made)
  (alias 'llm    'shop3-zmq.llm)
  ;(alias 'llmt   'shop3-zmq.llm-test)
  (alias 'op     'shop3-zmq.operators)
  (alias 'shop   'shop3-zmq.shop)
  (alias 'spec   'shop3-zmq.specs)
  (alias 'sutil  'shop3-zmq.sutil))
